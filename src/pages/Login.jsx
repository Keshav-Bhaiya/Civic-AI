  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <img
          src="https://images.pexels.com/photos/1519088/pexels-photo-1519088.jpeg?auto=compress&cs=tinysrgb&w=800&h=1200&dpr=1"
          alt="City"
          ...
          <div className="mt-auto mb-8">
            ...
            <div className="grid grid-cols-3 gap-3 mt-8">
              {[
                ...
                { value: '8,200+', label: 'Issues Resolved' },
                { value: '1,600+', label: 'Active Citizens' },
              ].map(({ value, label }) => (
            ...
            <div className="space-y-3 mt-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/10 flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-white text-xs font-semibold">AI Detected Issue</p>
                  <p className="text-gray-300 text-xs">Pothole on Main St · High severity</p>
                </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/10 flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-white text-xs font-semibold">Community Health Score</p>
                  <div className="flex items-center gap-2 mt-1">
                    <div className="flex-1 bg-white/20 rounded-full h-1">
                      <div className="bg-green-400 h-1 rounded-full" style={{ width: '94%' }} />
                    </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3 border border-white/10 flex items-center gap-3">
                <div className="w-9 h-9 bg-purple-500/30 rounded-lg flex items-center justify-center">
                  <MapPin size={16} className="text-purple-400" />
                </div>
                <div className="flex-1">
                  <p className="text-white text-xs font-semibold">Live Map Activity</p>
                  <p className="text-gray-300 text-xs">24 new pins added in your area</p>
                </div>
                <span className="text-blue-400 text-xs font-bold">24</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="flex -space-x-2">
              {[
                ...
                <img key={i} src={src} alt="" className="w-8 h-8 rounded-full border-2 border-gray-800 object-cover" />
              ))}
            </div>
            <p className="text-gray-300 text-sm">2.1M+ citizens already joined</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex gap-4 mb-8">
            ...
            <Link to="/signup" className="pb-2 text-sm font-medium text-gray-400 border-b-2 border-transparent hover:text-gray-700 transition-colors">
              Create Account
            </Link>
          </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-5">
            ...
            <Link to="/signup" className="text-green-600 font-semibold hover:underline">Create one free</Link>
          </p>
